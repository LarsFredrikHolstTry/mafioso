...
<?php } else { ?>
    ...
    <div class="col-4" style="padding-top: 0px;">
        <div class="content">
            ...
            <b>Forklaring:</b>
            <br>
            <div class="dot" style='background-color: rgba(50, 205, 50, 0.1);'></div>Lite
            <br>
            <div class="dot" style='background-color: rgba(50, 205, 50, 0.5);'></div>Middels (Over 5 trykk på samme sted)
            <br>
            <div class="dot" style='background-color: rgba(50, 205, 50, 1);'></div>Mye (Stor risiko om bot)
            <style>
                .dot {
                    float: left;
                    height: 1px;
