...
(function (l) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Ingen data" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "Laster" === b.sLoadingRecords &&
    ...
    function lb(a, b, c) {
        var d = a._iDisplayStart,
            e = a._iDisplayLength,
            h = a.fnRecordsDisplay();
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > h && (d = 0)) : "Første side" == b ? d = 0 : "forrige side" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) :
            "neste side" == b ? d + e < h && (d += e) : "siste side" == b ? d = Math.floor((h - 1) / e) * e : da(a, 0, "Unknown paging action: " + b, 5);
...
"row().child().hide()"], function () {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {
                ...
                sLast: "siste side",
                sNext: "neste side",
                sPrevious: "forrige side"
            },
            sEmptyTable: "Ingen data",
            sInfo: " ",
            sInfoEmpty: " ",
            sInfoFiltered: "",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Vis _MENU_ rader",
            sLoadingRecords: "Laster...",
            sProcessing: "Laster...",
            sSearch: "Søk:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Ingen data å vise"
        },
    ...
    l.extend(dc, {
        simple: function (a, b) {
            return ["forrige side", "neste side"]
        },
        full: function (a, b) {
            return ["Første side", "forrige side", "neste side", "siste side"]
        },
        numbers: function (a, b) {
            return [Da(a, b)]
        },
        simple_numbers: function (a, b) {
            return ["forrige side", Da(a, b), "neste side"]
        },
        full_numbers: function (a, b) {
            return ["Første side", "forrige side", Da(a, b), "neste side", "siste side"]
        },
        first_last_numbers: function (a, b) {
            return ["Første side", Da(a, b), "siste side"]
        },
        _numbers: Da,
        numbers_length: 7
    });
