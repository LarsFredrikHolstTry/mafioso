...
(function ($) {
  $.fn.bbcode = function (options) {
    ...
    $(this).wrap(
      '<div id="bbcode_container"></div>'
    );
    $("#bbcode_container").prepend(text);
    $("#bbcode_bb_bar a img").css(
      "border",
      "none"
    );
    var id = "#" + $(this).attr("id");
